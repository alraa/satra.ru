...
(function($) {
	...
	$.fn.styler = function(options) {
		...
		var opt = $.extend({
			wrapper: 'form',
			idSuffix: '-styler',
			filePlaceholder: 'Загрузить документ',
									...
									if (opt.selectSmartPositioning) {
										...
										if (bottomOffset > (minHeight + searchHeight + 20))	{
											...
											var maxHeightBottom = function() {
												...
												ul.css('max-height', Math.floor((bottomOffset ) / liHeight) * liHeight  +43);
											};
											maxHeightBottom();
										...
										// раскрытие вверх
											...
											var maxHeightTop = function() {
												...
												ul.css('max-height', Math.floor((topOffset - win.scrollTop()) / liHeight) * liHeight);
											};
											maxHeightTop();
											ul.css('max-height', newHeight);
											if (isMaxHeight != 'none') {
